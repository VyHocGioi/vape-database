...
$section = array(
    'title'      => esc_html__('Social Management', 'vape'),
    'desc'       => esc_html__('Import Social icon and Social link'),
    'id'         => 'opt-social',
    'subsection' => true,
    'fields'     => array(
        array(
            'id'       => 'link-social-1',
            'type'     => 'text',
            'title'    => esc_html__('Social link 1', 'vape'),
            'subtitle' => esc_html__('URL', 'vape'),
            'desc'     => esc_html__('Enter social link 1', 'vape'),
        ...
        array(
            ...
            'type'     => 'media',
            'url'   => true,
            'title'    => esc_html__('Add/Edit social icon 1', 'vape'),
            'subtitle' => esc_html__('Impage', 'vape'),
            'desc'     => esc_html__('Import new Icon by selecting existing or uploading new icons.', 'vape'),
        ),
        array(
            'id'       => 'link-social-2',
            'type'     => 'text',
            'title'    => esc_html__('Social link 2', 'vape'),
            'subtitle' => esc_html__('URL', 'vape'),
            'desc'     => esc_html__('Enter social link 2', 'vape'),
            'default'  => 'Default Text',
        ),
        array(
            'id'       => 'opt-icon-2',
            'type'     => 'media',
            'url'   => true,
            'title'    => esc_html__('Add/Edit social icon 2', 'vape'),
            'subtitle' => esc_html__('Impage', 'vape'),
            'desc'     => esc_html__('Import new Icon by selecting existing or uploading new icons.', 'vape'),
        ),
        array(
            'id'       => 'link-social-3',
            'type'     => 'text',
            'title'    => esc_html__('Social link 3', 'vape'),
            'subtitle' => esc_html__('URL', 'vape'),
            'desc'     => esc_html__('Enter social link 3', 'vape'),
            'default'  => 'Default Text',
        ),
        array(
            'id'       => 'opt-icon-3',
            'type'     => 'media',
            'url'   => true,
            'title'    => esc_html__('Add/Edit social icon 3', 'vape'),
            'subtitle' => esc_html__('Impage', 'vape'),
            'desc'     => esc_html__('Import new Icon by selecting existing or uploading new icons.', 'vape'),
        ),
        array(
            'id'       => 'link-social-4',
            'type'     => 'text',
            'title'    => esc_html__('Social link 4', 'vape'),
            'subtitle' => esc_html__('URL', 'vape'),
            'desc'     => esc_html__('Enter social link 1', 'vape'),
            'default'  => 'Default Text',
        ),
        array(
            ...
            'type'     => 'media',
            'url'   => true,
            'title'    => esc_html__('Add/Edit social icon 4', 'vape'),
            'subtitle' => esc_html__('Impage', 'vape'),
            'desc'     => esc_html__('Import new Icon by selecting existing or uploading new icons.', 'vape'),
        ),
    ),
...
$section = array(
    'title'      => esc_html__('Notification', 'vape'),
    'desc'       => esc_html__('Enter notification'),
    'id'         => 'opt-notification',
    'subsection' => true,
...
Redux::set_field('vape_options', 'opt-notification', array(
    'id' => 'otp-textarea',
    'type' => 'textarea',
    'title' => __('Notification', 'redux_docs_generator'),
    'subtitle' => __('Textare', 'redux_docs_generator'),
    'desc' => __('Enter notification', 'redux_docs_generator')
));
Redux::set_section($opt_name, $section);
